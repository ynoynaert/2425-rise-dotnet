...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rise.Domain.Quotes.TradedMachinery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TradedMachineries");
                });

            modelBuilder.Entity("Rise.Domain.Quotes.TradedMachineryImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("TradedMachineryId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TradedMachineryId");

                    b.ToTable("TradedMachineryImage", (string)null);
                });
            ...
            modelBuilder.Entity("Rise.Domain.Quotes.TradedMachineryImage", b =>
                {
                    b.HasOne("Rise.Domain.Quotes.TradedMachinery", "TradedMachinery")
                        .WithMany("Images")
                        .HasForeignKey("TradedMachineryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TradedMachinery");
                });
            ...
            modelBuilder.Entity("Rise.Domain.Quotes.Quote", b =>
                {
                    ...
                    b.Navigation("TradedMachineries");
                });
            ...
            modelBuilder.Entity("Rise.Domain.Quotes.TradedMachinery", b =>
                ...
                modelBuilder.Entity("Rise.Domain.Inquiry.Inquiry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rise.Domain.Inquiry.InquiryOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
